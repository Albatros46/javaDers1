...
public class Main {
	...
	//Polimorphisim = bir nesnenin birden fazla nesne gibi davranmasıdir.
        ...
        //Polimorphism de kullanılan nesnelerin hangi class da olduğunun öğrenmek için InstanceOf kullanılır.
        ...
        if (ogrenci3 instanceof Ogrenci) {
            System.out.println("Bu nesne Kimya Bölümünden");
        }
    }
