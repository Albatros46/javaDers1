...
public class Main {
    ...
    /*
    2 boyutlu arraylerle hafýza oyunu
    ...
    */
    ...
    public static void kayittanAl() {
        ...
        if (file.exists()) {
            ...
            System.out.print("Kaydedilmiþ bir oyununuz var. Kayýttan devam etmek ister misiniz ? (yes ya da no)");
    ...
    public static void main(String[] args) {
        ...
        while (oyunBittiMi() == false) {
            ...
            oyunTahtasi();
            System.out.print("Çýkýþ için q'ya basýn (yes ya da no)");
